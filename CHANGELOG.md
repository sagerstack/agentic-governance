...
- **0.15.0** — Group D Audit Integrity continuation: added canonical audit-chain verification helpers, claim-level reconstruction from governance JSONL, failure-sidecar loaders, and explicit source-of-truth constants (`governance_jsonl` vs DB projection vs telemetry). This completes deterministic verification/reconstruction support for the canonical audit spine.
